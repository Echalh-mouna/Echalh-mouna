...
🎓 **Cybersecurity Engineering Student** passionate about cybersecurity, artificial intelligence and security engineering.

I am interested in building practical solutions at the intersection of:

**🛡️ Cybersecurity × 🤖 AI × ⚙️ Automation**

My main areas of interest include **Threat Intelligence, Vulnerability Management, Security Monitoring, Phishing Detection, AI for Security and Security Automation**.
...
`Python` `LLM` `Ollama` `SQLite` `CTI` `CVE` `CVSS` `Automation`
...
`Python` `Scikit-learn` `Streamlit` `Machine Learning` `Cybersecurity`
...
| 🛡️ Cybersecurity | 🤖 AI × Security | ⚙️ Engineering |
|:---:|:---:|:---:|
...
I believe cybersecurity is not only about finding vulnerabilities.

It is about **understanding systems, anticipating threats and building better solutions**.

<div align="center">

> *Learn continuously. Build thoughtfully. Secure everything.* 💜
